...
| `core-index/folder-files.json` | 폴더 591036590 안 파일 15개의 키·페이지 (REST 조회 원본) | `scripts/figma-rest/list-project-files.py 591036590 --pages` 출력 |
| `scripts/figma-rest/` | Figma REST 폴더 조회 스크립트 | `--check`로 토큰·네트워크 점검. 2026-09-18 개통 (권한 `file_content:read`+`folders:read`) |
