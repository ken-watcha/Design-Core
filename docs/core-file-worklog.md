...
- **프로젝트의 목적 재확인 (Ken, 2026-09-10)**: "지금 바로 적용"이 아니라 **Core 파일 업데이트를 쉽게 하는 프로그램(도우미)을 만드는 것**. 도우미가 Ken에게 묻지 않고 스스로 판단하게 만들어야 함 → 질문으로 넘기던 것을 데이터로 푸는 절차·도구를 만들어 지침서에 넣는 방향
